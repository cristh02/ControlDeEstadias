<!DOCTYPE HTML>
    <HTML lang="es">
        <head>
            ...
            <img class="fond2" src="../3_imagenes/sev.jpg">
            <img class="fondo1" src="../3_imagenes/utsv.png">
            <img class="fondo3" src="../3_imagenes/images.jpeg">
            <TITLE>ESTADIA</TITLE>
        </head>
        <body class="doc">
        	<center><h1>FORMATO DE SOLICITUD DE ESTADIAS UTSV</h1><h1 id="segundo">UTSV-DVI-FO-02</h1></center>
                <p style="text-align:right;">Nanchital, ver. </p>
                <p style="text-align:right;">Fecha: <input type="date" name="fecha" > </p>
                    <h4>DRA.SILVIA ELENA LÒPEZ VALLEJO </h4>
                    <h4>DIRECTORA DE VINCULACIÓN </h4>
                    <h4>PRESENTE.-</h4>
                <p>Solicito su apoyo para que se pueda elaborar la carta de presentación para mis Estadias.</p>
